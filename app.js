...
// Coordinates are now determined automatically from Mission City, Mission State, and Mission Country.
...
const US_STATE_FLAG_FILES = {
  ...
  "district of columbia":"Flag of Washington, D.C.svg","washington dc":"Flag of Washington, D.C.svg","washington d.c.":"Flag of Washington, D.C.svg"
};

const SUBDIVISION_FLAG_FILES = {
  "canada": {
    "alberta":"Flag of Alberta.svg","british columbia":"Flag of British Columbia.svg","manitoba":"Flag of Manitoba.svg","new brunswick":"Flag of New Brunswick.svg",
    "newfoundland and labrador":"Flag of Newfoundland and Labrador.svg","nova scotia":"Flag of Nova Scotia.svg","ontario":"Flag of Ontario.svg",
    "prince edward island":"Flag of Prince Edward Island.svg","quebec":"Flag of Quebec.svg","saskatchewan":"Flag of Saskatchewan.svg",
    "northwest territories":"Flag of the Northwest Territories.svg","nunavut":"Flag of Nunavut.svg","yukon":"Flag of Yukon.svg"
  },
  "australia": {
    "new south wales":"Flag of New South Wales.svg","queensland":"Flag of Queensland.svg","south australia":"Flag of South Australia.svg",
    "tasmania":"Flag of Tasmania.svg","victoria":"Flag of Victoria (Australia).svg","western australia":"Flag of Western Australia.svg",
    "australian capital territory":"Flag of the Australian Capital Territory.svg","northern territory":"Flag of the Northern Territory.svg"
  },
  "germany": {
    "baden-wurttemberg":"Flag of Baden-Württemberg.svg","baden württemberg":"Flag of Baden-Württemberg.svg","bavaria":"Flag of Bavaria.svg","bayern":"Flag of Bavaria.svg",
    "berlin":"Flag of Berlin.svg","brandenburg":"Flag of Brandenburg.svg","bremen":"Flag of Bremen.svg","hamburg":"Flag of Hamburg.svg","hesse":"Flag of Hesse.svg","hessen":"Flag of Hesse.svg",
    "lower saxony":"Flag of Lower Saxony.svg","niedersachsen":"Flag of Lower Saxony.svg","mecklenburg-vorpommern":"Flag of Mecklenburg-Western Pomerania.svg",
    "north rhine-westphalia":"Flag of North Rhine-Westphalia.svg","nordrhein-westfalen":"Flag of North Rhine-Westphalia.svg",
    "rhineland-palatinate":"Flag of Rhineland-Palatinate.svg","rheinland-pfalz":"Flag of Rhineland-Palatinate.svg","saarland":"Flag of Saarland.svg",
    "saxony":"Flag of Saxony.svg","sachsen":"Flag of Saxony.svg","saxony-anhalt":"Flag of Saxony-Anhalt.svg","sachsen-anhalt":"Flag of Saxony-Anhalt.svg",
    "schleswig-holstein":"Flag of Schleswig-Holstein.svg","thuringia":"Flag of Thuringia.svg","thüringen":"Flag of Thuringia.svg"
  },
  "brazil": {
    "acre":"Bandeira do Acre.svg","alagoas":"Bandeira de Alagoas.svg","amapa":"Bandeira do Amapá.svg","amapá":"Bandeira do Amapá.svg",
    "amazonas":"Bandeira do Amazonas.svg","bahia":"Bandeira da Bahia.svg","ceara":"Bandeira do Ceará.svg","ceará":"Bandeira do Ceará.svg",
    "distrito federal":"Bandeira do Distrito Federal (Brasil).svg","espirito santo":"Bandeira do Espírito Santo.svg","espírito santo":"Bandeira do Espírito Santo.svg",
    "goias":"Flag of Goiás.svg","goiás":"Flag of Goiás.svg","maranhao":"Bandeira do Maranhão.svg","maranhão":"Bandeira do Maranhão.svg",
    "mato grosso":"Bandeira de Mato Grosso.svg","mato grosso do sul":"Bandeira de Mato Grosso do Sul.svg","minas gerais":"Bandeira de Minas Gerais.svg",
    "para":"Bandeira do Pará.svg","pará":"Bandeira do Pará.svg","paraiba":"Bandeira da Paraíba.svg","paraíba":"Bandeira da Paraíba.svg",
    "parana":"Bandeira do Paraná.svg","paraná":"Bandeira do Paraná.svg","pernambuco":"Bandeira de Pernambuco.svg","piaui":"Bandeira do Piauí.svg","piauí":"Bandeira do Piauí.svg",
    "rio de janeiro":"Bandeira do estado do Rio de Janeiro.svg","rio grande do norte":"Bandeira do Rio Grande do Norte.svg","rio grande do sul":"Bandeira do Rio Grande do Sul.svg",
    "rondonia":"Bandeira de Rondônia.svg","rondônia":"Bandeira de Rondônia.svg","roraima":"Bandeira de Roraima.svg","santa catarina":"Bandeira de Santa Catarina.svg",
    "sao paulo":"Bandeira do estado de São Paulo.svg","são paulo":"Bandeira do estado de São Paulo.svg","sergipe":"Bandeira de Sergipe.svg","tocantins":"Bandeira do Tocantins.svg"
  }
};

function flagKey(value){
...
function countryFlagUrl(country){
  const code = COUNTRY_CODES[flagKey(country)];
  return code ? `https://flagcdn.com/w80/${code}.png` : "";
}

function subdivisionFlagUrl(country,state){
  const c = flagKey(country);
  const s = flagKey(state);
  if(!c || !s) return "";

  if(["united states","usa","us"].includes(c) && US_STATE_FLAG_FILES[s]){
    return commonsFilePath(US_STATE_FLAG_FILES[s]);
  }

  const file = SUBDIVISION_FLAG_FILES[c] && SUBDIVISION_FLAG_FILES[c][s];
  return file ? commonsFilePath(file) : "";
}
...
function getFlagImage(country,state){
  ...
  if(url){
    ...
    return `<img class="flag-img" src="${url}" alt="${escapeAttr(alt)}" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src='${fallback}';">`;
  }
...
const GEOCODE_CACHE_KEY = "haagMissionaryMapGeocodeCacheV1";
let geocodeCache = {};
try {
...
function buildGeocodeQueries(m){
  ...
  const missionParts = [mission, state, country].filter(Boolean);
  const queries = [];

  if(placeParts.length) queries.push(placeParts.join(", "));
  if(missionParts.length) queries.push(missionParts.join(", "));
  if(mission && country) queries.push(`${mission}, ${country}`);
...
async function geocodeMissionary(m){
  const cacheKey = normalize([getMissionName(m), getCity(m), getState(m), getCountry(m)].join("|"));
  if(geocodeCache[cacheKey]) return geocodeCache[cacheKey];

  const queries = buildGeocodeQueries(m);
  for(const query of queries){
    try {
      await sleep(1100);
      const coords = await geocodeOneQuery(query);
      if(coords){
  ...
  console.warn("No coordinates found for:", getMissionName(m), getCity(m), getState(m), getCountry(m));
  return null;
}
...
async function buildMap(){
  ...
  for(const m of missionaries){
    const coords = await geocodeMissionary(m);
    allMissionaries.push({...m, coords});
  }
